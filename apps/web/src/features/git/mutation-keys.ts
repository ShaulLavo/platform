export const mutationKeys = {
  checkout: (rootPath: string) =>
    ["git", "mutation", "checkout", rootPath] as const,
  commit: (rootPath: string) =>
    ["git", "mutation", "commit", rootPath] as const,
  createBranch: (rootPath: string) =>
    ["git", "mutation", "create-branch", rootPath] as const,
  discard: (path: string) => ["git", "mutation", "discard", path] as const,
  discardMany: (paths: readonly string[]) =>
    ["git", "mutation", "discard-many", ...paths] as const,
  ...
  unstageMany: (paths: readonly string[]) =>
    ["git", "mutation", "unstage-many", ...paths] as const,
}
