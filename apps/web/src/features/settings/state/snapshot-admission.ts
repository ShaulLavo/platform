...
export function beginSettingsSnapshotRead(queryClient: QueryClient): SettingsSnapshotReadToken {
...
export function observeInitialSettingsSnapshot(
  ...
  if (!current) {
    ...
    accepted = snapshot.serverVersion.sequence > current.serverVersion.sequence ? snapshot : current
...
export async function admitSettingsMutationResult(
  queryClient: QueryClient,
...
export async function admitSettingsEvent(
  queryClient: QueryClient,
  event: SettingsEvent,
): Promise<AdmissionResult> {
...
export async function admitSettingsRawResult(
  queryClient: QueryClient,
...
export async function refreshConfirmedSettings(queryClient: QueryClient, signal?: AbortSignal) {
...
export function resetSettingsSnapshotAdmission(queryClient: QueryClient) {
