...
export function canMinimizeSurface(registry: SurfaceRegistry, surface: Surface) {
  return registeredSurfaceCapabilities(registry, surface)?.canMinimize ?? false
}
...
export function canUnmountSurfaceWhenHidden(registry: SurfaceRegistry, surface: Surface) {
  return registeredSurfaceCapabilities(registry, surface)?.canUnmountWhenHidden ?? false
}
