...
import { FileViewerBody } from '@/components/workspace/file-viewer-body'
import {
  joinedEditorRenderDocument,
  readyFile,
} from '@/components/workspace/editor-render-document-utils'
import { useConflictEditorResolution } from '@/components/workspace/use-conflict-editor-resolution'
...
export function EditorPaneTabBody({
  active,
  editorKeymapLayers,
  path,
  rootPath,
