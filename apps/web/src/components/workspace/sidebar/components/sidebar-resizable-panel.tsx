import { Sidebar } from '@/components/workspace/sidebar/components/sidebar'
import {
...
type SidebarResizablePanelProps = {
  rootPath: string
  treeReady: boolean
...
export const SidebarResizablePanel = memo(
  ({
    onLoadDirectory,
    onPrefetchDirectory,
    rootPath,
