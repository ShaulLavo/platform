...
} from '@/components/workspace/terminal/utils/terminal-height'
 ...
 */
export function useTerminalHeight(rootPath: string) {
  const setTerminalCollapsed = useTerminalState((state) => state.setTerminalCollapsed)
