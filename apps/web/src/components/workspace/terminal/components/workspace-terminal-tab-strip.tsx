...
import { WorkspaceTerminalTab } from '@/components/workspace/terminal/components/workspace-terminal-tab'

export function WorkspaceTerminalTabStrip({ rootPath }: { rootPath: string }) {
  const activeTerminalTabId = useWorkspaceTerminalState((state) => state.activeTerminalTabId)
  const closeTerminalTab = useWorkspaceTerminalState((state) => state.closeTerminalTab)
  const createTerminalTab = useWorkspaceTerminalState((state) => state.createTerminalTab)
  const setActiveTerminalTabId = useWorkspaceTerminalState((state) => state.setActiveTerminalTabId)
