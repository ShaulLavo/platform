...
import { EditorPaneDropContext } from '@/components/workspace/editor-panes/providers/editor-pane-drop-context'
...
import type { EditorPaneSplitDropTarget } from '@/components/workspace/file-tree/utils/file-viewer-types'
