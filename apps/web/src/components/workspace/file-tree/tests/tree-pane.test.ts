...
import type { FileTreeDirectoryHandle, FileTreeFileHandle, FileTreeItemHandle } from '@pierre/trees'
...
function getFile(tree: PierreFileTree, path: string): FileTreeFileHandle {
  const item = tree.getItem(path)
