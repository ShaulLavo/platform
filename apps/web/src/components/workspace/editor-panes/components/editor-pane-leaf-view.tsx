...
import { EditorPaneDropOverlay } from '@/components/workspace/editor-panes/components/editor-pane-drop-overlay'
import {
  editorPaneDropTarget,
  eventTargetsEditorTabBar,
} from '@/components/workspace/editor-panes/utils/editor-pane-drop-utils'
import { EditorPaneLeafContent } from '@/components/workspace/editor-panes/components/editor-pane-leaf-content'
import { EditorTabBar } from '@/components/workspace/editor-tabs/components/editor-tab-bar'
import { useEditorPaneDropContext } from '@/components/workspace/editor-panes/hooks/use-editor-pane-drop-context'
import {
