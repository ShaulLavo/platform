...
export function chromeTabRootClassName({
  ...
  return cn(
    'group group/chrome-tab relative flex items-center overflow-hidden rounded-[6px] bg-background text-xs text-muted-foreground/70 outline-none focus-visible:outline-none',
