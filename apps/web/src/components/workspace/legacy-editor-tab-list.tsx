...
import type { EditorTabModel, EditorTabSizing } from '@/components/workspace/editor-tab-types'
import {
  editorTabInsertionEdge,
  type EditorTabDragController,
} from '@/components/workspace/use-editor-tab-drag'
import { LegacyTabCloseButton } from '@/components/workspace/legacy-tab-close-button'
