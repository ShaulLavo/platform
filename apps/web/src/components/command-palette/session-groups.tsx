...
import { SessionPaletteRow } from '@/components/command-palette/session-palette-row'
import { SessionProjectPaletteRow } from '@/components/command-palette/session-project-palette-row'
import type {
  SessionRailItem,
  SessionRailProject,
