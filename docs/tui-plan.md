...
- The [native PTY and binary transport](terminal.md) are available for slice 080 (§7.5).
...
| **080 — Workbench surfaces**                   | Embedded terminal pane and attach; file tree; viewer with find, diagnostics, hover, go-to-definition; `$EDITOR` handoff through workspace-edit; diff painter; git panel; search; problems; logs; workbench screen layout and persistence; server items 7.3, 7.4                                                                                                                                                                                                                                                                                                                              | 079, native PTY, S1, S3, S5                                                                                                          |
