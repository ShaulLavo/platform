...
- **PLAN.md is the spine.** The reconciled cross-project roadmap schedules the remaining keymap and
  diagnostic-surface work. The CommandBus, FocusService, WorkspaceEdit transaction,
