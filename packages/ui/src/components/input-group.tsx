...
const inputGroupAddonVariants = cva(
  "flex h-auto cursor-text items-center justify-center gap-(--density-input-group-addon-gap) py-(--density-input-group-addon-padding-y) text-xs font-medium text-muted-foreground select-none group-data-[disabled=true]/input-group:opacity-50 [&>kbd]:rounded-none [&>svg:not([class*='size-'])]:size-4",
  {
    variants: {
      align: {
        'inline-start':
