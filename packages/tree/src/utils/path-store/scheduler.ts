...
export function createPathStoreScheduler(options: PathStoreSchedulerOptions): PathStoreScheduler {
  ...
  function notify(): void {
    ...
    setBenchmarkCounter(instrumentation, 'scheduler.cancelledTaskCount', metrics.cancelledTaskCount)
    ...
    setBenchmarkCounter(instrumentation, 'scheduler.completedTaskCount', metrics.completedTaskCount)
